  ...
  categories: [
    {
      ...
      items: [
        ...
        {
          id: 'doc.registration',
          title: '車両登録証 / 自賠責 / 納税関連の書類がそろっている',
          description:
            '日本での登録時は車検証や納税証明、自賠責保険証の有無を確認。',
          severity: 'critical',
        },
        {
          id: 'doc.warranty',
        ...
        },
        {
          ...
          title: 'モバイルコネクター / 充電アダプターの種類と数量',
          description:
            '同梱されている充電ケーブルと家庭用 / 200V / 急速充電用アダプターの種類と数量を確認。',
          severity: 'major',
        },
        {
          id: 'doc.floormats',
          title: 'フロアマットが規定数そろっている',
          description:
            '注文書・パッケージリストに記載された枚数のフロアマットがそろっているか確認。',
          severity: 'minor',
        },
        {
          id: 'doc.manuals',
